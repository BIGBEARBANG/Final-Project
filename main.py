...
with st.echo(code_location='below'):
    ...
    df_t=df_eff.dropna(axis=1).concat(df_type_count.loc['Average amount of prescriptions'])
    ...
    df_ri=df_rub.concat(df_tablet.loc['Average cost per tablet 2013-2019']).dropna(axis=1)
    ...
    df_sp=df_ri.concat([df_t.loc['Average amount of prescriptions'],df_t.loc['clinical eff']]).dropna(axis=1).transpose().reset_index()
