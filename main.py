...
with st.echo(code_location='below'):
    ...
    df_t=pd.concat([df_eff.dropna(axis=1), df_type_count.loc['Average amount of prescriptions']], columns = list(df_eff.dropna(axis=1))+['Average amount of prescriptions'])
